...
namespace FrostWoodTech.API.Migrations
{
    ...
    [Migration("20260905163804_AddCurrencies")]
            ...
            modelBuilder.Entity("FrostWoodTech.API.Entities.Currency", b =>
                {
                    ...
                    b.Property<decimal>("RateFromUsd")
                        .HasColumnType("numeric(18,6)")
                        .HasColumnName("rate_from_usd");
                    ...
                    b.ToTable("currencies", null, t =>
                        {
                            t.HasCheckConstraint("ck_currencies_rate_positive", "rate_from_usd > 0");
                        });
                });
